...
def wikitextPerplexity(model):
    ...
    # 
    # base      MP 10%      MP 20%      MP 30%
    # 785048
    # 25.1058   24.1673     23.3851
    # 16.1045   15.6928     14.7302
    # 237139    
    # 36640.2
    # 30.487    29.2389     30.4717
    # 25.8084   25.3759     25.2443
    # 27617.4
    # 18.8705   18.6044     17.8785
    # 19.5916   19.2132     18.4784
